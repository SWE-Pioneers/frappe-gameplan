# CLAUDE.md — frappe-gameplan (SWE-Pioneers fork)

Changes on top of upstream `frappe/gameplan` (main).

## Arabic i18n
- `gameplan/locale/ar.po` completed to **100% of app-owned strings** (Libyan-appropriate MSA), tagged
...
## Deploy
Built from `~/build/gameplan-custom` on the VPS (Containerfile repointed to this fork + per-app
