...
// Drag the resize handle below this and the composer collapses instead of
// shrinking further. Well under the open floor so the editor shrinks most of the
// way down before it gives way to the collapsed bar — a more natural hand-off.
