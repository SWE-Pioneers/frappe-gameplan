    ...
    <div class="space-y-5 pb-40">
      ...
      <div class="sm:rounded sm:border sm:px-4 sm:py-3">
        <div class="mb-3 flex items-center justify-between">
          <h2 class="text-3xl-semibold text-ink-gray-7">Discussions</h2>
      ...
      <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
        <div class="sm:rounded sm:border sm:px-4 sm:py-3">
          <div class="mb-3 flex items-center justify-between">
            <h2 class="text-3xl-semibold text-ink-gray-7">Tasks</h2>
        ...
        <div class="sm:rounded sm:border sm:px-4 sm:py-3">
          <div class="mb-3 flex items-center justify-between">
            <h2 class="text-3xl-semibold text-ink-gray-7">Pages</h2>
